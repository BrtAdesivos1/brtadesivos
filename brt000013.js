...
// 🎨 ALTERAÇÃO DE COR: Altera a seleção visual e atualiza o texto para "Branco" ou "Preto"
function mudarCor(botao, nomeDaCor) {
  ...
  // Atualiza o texto na tela ao lado de "Cor:" dinamicamente
  document.getElementById('cor-selecionada').innerText = nomeDaCor;
}
